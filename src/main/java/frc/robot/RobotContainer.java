...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    new JoystickButton(joystick1,1).whileActiveOnce(new DriveForwardCmd(driveSubsystem,DriveContasts.SPEED_LEFT ,DriveContasts.SPEED_RIGHT));
    // robot rotate speedleri vermeyi unutma!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  }
  /**
